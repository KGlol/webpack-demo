...
module.exports = {
  ...
  devtool: 'cheap-module-eval-source-map', // sourceMap设置 开发环境下 速度较快
  ...
  output: {
    ...
    path: path.resolve(__dirname, 'bulid') // output路径必须为绝对路径
  },


  // webpack默认找js文件，设置兼容jsx
  resolve: {
    // import jsx文件时不必再写后缀名(性能优化 优先查找 写上后缀名查找更快)
    extensions: ['.js', '.jsx'],
    // 别名(性能优化 减少查找过程)
    alias: {
